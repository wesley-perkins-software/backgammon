...
export default function PrivacyPage() {
  return (
    <article className="content-page">
      <SEO
        title="Privacy - Play Backgammon"
        description="Read the Play Backgammon privacy policy: no required account, browser-based game storage, limited data collection, and steps to clear local data."
        path="/privacy"
      />
      <h1>Privacy</h1>
      <p>
        We designed Play Backgammon so you can play without creating an account or sharing personal profile details on playbackgammon.net. This page explains what
        data is used, why it is used, and what choices you have.
      </p>

      <h2>Information we collect</h2>
      <p>Play Backgammon is primarily a browser-based game and does not require direct personal information to start playing.</p>
      <ul>
      ...
      <h2>Contact</h2>
      <p>
        For privacy questions related to playbackgammon.net, contact us through the site.
      </p>
